...
//thế mà bảo bye
Blockly.Lua=new Blockly.Generator("Lua");Blockly.Lua.addReservedWords("___inext,assert,bit,colors,colours,coroutine,disk,dofile,error,fs,fetfenv,getmetatable,help,io,ipairs,keys,loadfile,loadstring,math,native,next,os,paintutils,pairs,parallel,pcall,peripheral,print,printError,rawequal,rawget,rawset,read,rednet,redstone,rs,select,setfenv,setmetatable,sleep,string,table,term,textutils,tonumber,tostring,type,unpack,vector,write,xpcall,_VERSION,__indext,HTTP,and,break,do,else,elseif,end,false,for,function,if,in,local,nil,not,or,repeat,return,then,true,until,while,add,sub,mul,div,mod,pow,unm,concat,len,eq,lt,le,index,newindex,call,assert,collectgarbage,dofile,error,_G,getmetatable,inpairs,load,loadfile,next,pairs,pcall,print,rawequal,rawget,rawlen,rawset,select,setmetatable,tonumber,tostring,type,_VERSION,xpcall,require,package,string,table,math,bit32,io,file,os,debug");
Blockly.Lua.ORDER_ATOMIC=0;Blockly.Lua.ORDER_HIGH=1;Blockly.Lua.ORDER_EXPONENTIATION=2;Blockly.Lua.ORDER_UNARY=3;Blockly.Lua.ORDER_MULTIPLICATIVE=4;Blockly.Lua.ORDER_ADDITIVE=5;Blockly.Lua.CONCATENATION=6;Blockly.Lua.ORDER_RELATIONAL=7;Blockly.Lua.ORDER_AND=8;Blockly.Lua.ORDER_OR=9;Blockly.Lua.ORDER_NONE=10;Blockly.Lua.INFINITE_LOOP_TRAP=null;Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_="{{{}}}";Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_REGEXP_=new RegExp(Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_,"g");
...
Blockly.Lua.provideFunction_=function(a,b){if(!Blockly.Lua.definitions_[a]){var c=Blockly.Lua.variableDB_.getDistinctName(a,Blockly.Generator.NAME_TYPE);Blockly.Lua.functionNames_[a]=c;Blockly.Lua.definitions_[a]=b.join("\n").replace(Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_REGEXP_,c)}return Blockly.Lua.functionNames_[a]};Blockly.Lua.variables={}
Blockly.Lua.variables_get=function(a){return[Blockly.Lua.variableDB_.getName(a.getTitleValue("VAR"),Blockly.Variables.NAME_TYPE),Blockly.Lua.ORDER_ATOMIC]}
Blockly.Lua.variables_set=function(a){var b=Blockly.Lua.valueToCode(a,"VALUE",Blockly.Lua.ORDER_NONE)||"0";return Blockly.Lua.variableDB_.getName(a.getTitleValue("VAR"),Blockly.Variables.NAME_TYPE)+" = "+b+"\n"};
...
Blockly.Lua.text_print=function(a){return"print("+(Blockly.Lua.valueToCode(a,"TEXT",Blockly.Lua.ORDER_NONE)||"''")+")\n"};Blockly.Lua.text_prompt=function(a){var b=Blockly.Lua.provideFunction_("text_prompt",["function "+Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_+"(msg)","  io.write(msg)","  io.flush()","  return io.read()","end"]);a=Blockly.Lua.quote_(a.getTitleValue("TEXT"));return[b+"("+a+")",Blockly.Lua.ORDER_HIGH]}
// Blockly.Lua.EVENT={};Blockly.Lua.playerEvent=function(a){a=Blockly.Lua.valueToCode(a,"EVENT",Blockly.Lua.ORDER_NONE);return a="ScriptSupportEvent:registerEvent([=["+a+"]=])"};
...
Blockly.HSV_VALUE = 1;
Blockly.Msg.EVERYTHING_HUE = 45;
///////////////////////////////////PLAYER EVENT
Blockly.Blocks['player_event'] = {
    init: function() {
      this.appendDummyInput()
          .appendField("When Player")
          .appendField(new Blockly.FieldDropdown([["Get Status Effect","Player.AddBuff"], ["Add New Item","Player.AddItem"], ["Enters Area","Player.AreaIn"], ["Leaves Area","Player.AreaOut"], ["Attacking","Player.Attack"], ["Attack Hits","Player.AttackHit"], ["Change Of Backpack Bar","Player.BackPackChange"], ["Take Damage","Player.BeHurt"], ["Change Of Attribute","Player.ChangeAttr"], ["Click On Creation","Player.ClickActor"], ["Click On Block","Player.ClickBlock"], ["Colide With Other Player","Player.Colide"], ["Consume Item","Player.ConsumeItem"], ["Deals Damage To Other Object","Player.DamageActor"], ["Defeat Object","Player.DefeatActor"], ["Die","Player.Die"], ["Discard Item","Player.DiscardItem"], ["Cancel Riding Mount","Player.DismountActor"], ["Change Of Armor Bar","Player.EquipChange"], ["Unequip Armor","Player.EquipOff"], ["Equip Armor","Player.EquipOn"], ["Is Restored","Player.Init"], ["Events Triggered By Changes In ChatBox","Player.InputContent"], ["Button Pressed","Player.InputKeyDown"], ["Button Being Pressed","Player.InputKeyOnPress"], ["Button Released","Player.InputKeyUp"], ["Join Team","Player.JoinTeam"], ["When Player’s Level Changes","Player.LevelModelUpgrade"], ["Change Motion State","Player.MotionStateChange"], ["Ride Mount/Vehicles","Player.MountActor"], ["Move One Block","Player.MoveOneBlockSize"], ["Enter Yext String","Player.NewInputContent"], ["Pick Up Drop Item","Player.PickUpItem"], ["Change Of Expression","Player.PlayAction"], ["When Players Lose Status Effect","Player.RemoveBuff"], ["Respawn","Player.Revive"], ["Make Selection On Shortcut Bar","Player.SelectShortcut"], ["Change Of Shortcut Bar","Player.ShortcutChange"], ["Use Item","Player.UseItem"]]), "PLAYER_EVENT");
      this.appendStatementInput("FUNC")
          .setCheck(null)
          .appendField("Then Run Function");
          this.setColour(45)
          this.setNextStatement(true, null);
          this.setPreviousStatement(true, null);
   this.setTooltip("Add Event For Player With Function");
   this.setHelpUrl("https://developers.miniworldgame.com/wiki/event.html#player-event-player");
    }
  };
  Blockly.Lua['player_event'] = function(block) {
    var dropdown_player_event = block.getFieldValue('PLAYER_EVENT');
    var statements_func = Blockly.Lua.statementToCode(block, 'FUNC');
    var func = Math.floor(getRandomInt(1,1000000000)+getRandomInt(1,100000000000)+getRandomInt(1,10000000000000));
    var code = 'function func'+func+'(e)\n'+statements_func+'\nend\nScriptSupportEvent:registerEvent([=['+dropdown_player_event+']=],func'+func+')\n';
    return code;
  };
///////////////////////////////////WORLD EVENT
  Blockly.Blocks['world_event'] = {
    init: function() {
      this.appendDummyInput()
          .appendField("When The World")
          .appendField(new Blockly.FieldDropdown([["Change Of Weather","Weather.Changed"], ["Container Has Item Output","Backpack.ItemTakeOut"], ["Container Has Item Input","Backpack.ItemPutIn"], ["Change Of Backpack Bar","Backpack.ItemChange"]]), "WORLD_EVENT");
      this.appendStatementInput("FUNC")
          .setCheck(null)
          .appendField("Then Run Function");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(45);
   this.setTooltip("Add Event For World With Function");
   this.setHelpUrl("https://developers.miniworldgame.com/wiki/event.html#world-event-world");
    }
  };
  Blockly.Lua['world_event'] = function(block) {
    var dropdown_world_event = block.getFieldValue('WORLD_EVENT');
    var statements_func = Blockly.Lua.statementToCode(block, 'FUNC');
    var func = Math.floor(getRandomInt(1,1000000000)+getRandomInt(1,100000000000)+getRandomInt(1,10000000000000));
    var code = 'function func'+func+'(e)\n'+statements_func+'\nend\nScriptSupportEvent:registerEvent([=['+dropdown_world_event+']=],func'+func+')\n';
    return code;
  };
/////////////////////////////////////LOGIC GAME EVENT
Blockly.Blocks['logic_event'] = {
    init: function() {
      this.appendDummyInput()
          .appendField("When The Game")
          .appendField(new Blockly.FieldDropdown([["Any Player Is Defeated","Game.AnyPlayer.Defeat"], ["Any Player Enters Game","Game.AnyPlayer.EnterGame"], ["Any Player Leaves Game","Game.AnyPlayer.LeaveGame"], ["Any Player Loads Game","Game.AnyPlayer.ReadState"], ["Any Player Wins","Game.AnyPlayer.Victory"], ["Game Over","Game.End"], ["World Time Is [n]","Game.Hour"], ["Start Game","Game.Load"], ["Is Running","Game.Run"], ["World Time Is [n] Second","Game.RunTime"], ["Game Start","Game.Start"], ["Game Timeout","Game.TimeOver"], ["Any Change Of Timer","minitimer.change"]]), "LOGIC_EVENT");
      this.appendStatementInput("FUNC")
          .setCheck(null)
          .appendField("Then Run Function");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(45);
   this.setTooltip("Add Event For Logic Of Game");
   this.setHelpUrl("https://developers.miniworldgame.com/wiki/event.html#logic-event-game");
    }
  };
  Blockly.Lua['logic_event'] = function(block) {
    var dropdown_logic_event = block.getFieldValue('LOGIC_EVENT');
    var statements_func = Blockly.Lua.statementToCode(block, 'FUNC');
    var func = Math.floor(getRandomInt(1,1000000000)+getRandomInt(1,100000000000)+getRandomInt(1,10000000000000));
    var code = 'function func'+func+'(e)\n'+statements_func+'\nend\nScriptSupportEvent:registerEvent([=['+dropdown_logic_event+']=],func'+func+')\n';
    return code;
  };
////////////////////ACTOR EVENT
Blockly.Blocks['actor_event'] = {
    init: function() {
      this.appendDummyInput()
          .appendField("When Actor")
          .appendField(new Blockly.FieldDropdown([["Get Status Effect","Actor.AddBuff"], ["Enters Area","Actor.AreaIn"], ["Leaves Area","Actor.AreaOut"], ["Attacking","Actor.Attack"], ["Attack Hit","Actor.AttackHit"], ["And Player Greeted","Actor.BeGreetedBy"], ["Take Damage","Actor.BeHurt"], ["Defeat Other Object","Actor.Beat"], ["Change Of Attribute","Actor.ChangeAttr"], ["Change Motion State","Actor.ChangeMotion"], ["Colide With Other Object","Actor.Collide"], ["Is Created","Actor.Create"], ["Deals Damage To Others","Actor.Damage"], ["Die","Actor.Die"], ["Interact With Player","Actor.InteractEvent"], ["Creature Take Damage (Different Parameters)","Actor.NewBeHurt"], ["Smashed By Projectile","Actor.Projectile.Hit"], ["Lose Status Effect","Actor.RemoveBuff"], ["Send A Distress Message","Actor.ReqHelp"], ["Village Totem Binding Point Change","Actor.VillageBindPosChange"], ["Villages Work Binding Point Change","Actor.VillagerFlagChange"]]), "ACTOR_EVENT");
      this.appendStatementInput("FUNC")
        .setCheck(null)
        .appendField("Then Run Function");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(45);
   this.setTooltip("Add Event For Actor(Creature)");
   this.setHelpUrl("https://developers.miniworldgame.com/wiki/event.html#creature-event-actor");
    }
  };
  Blockly.Lua['actor_event'] = function(block) {
    var dropdown_actor_event = block.getFieldValue('ACTOR_EVENT');
    var statements_func = Blockly.Lua.statementToCode(block, 'FUNC');
    var func = Math.floor(getRandomInt(1,1000000000)+getRandomInt(1,100000000000)+getRandomInt(1,10000000000000));
    var code = 'function func'+func+'(e)\n'+statements_func+'\nend\nScriptSupportEvent:registerEvent([=['+dropdown_actor_event+']=],func'+func+')\n';
    return code;
  };
  //////////////////////////////////////BLOCK EVENT
  Blockly.Blocks['block_event'] = {
    init: function() {
      this.appendDummyInput()
          .appendField("When Block")
          .appendField(new Blockly.FieldDropdown([["Created","Block.Add"], ["Destroyed","Block.DestroyBy"], ["Start Mining","Block.Dig.Begin"], ["Cancel Mining","Block.Dig.Cancel"], ["Complete Mining","Block.Dig.End"], ["Being Fertilized","Block.Fertilize"], ["Being Placed","Block.PlaceBy"], ["Being Removed","Block.Remove"], ["Being Triggered","Block.Trigger"]]), "BLOCK_EVENT");
      this.appendStatementInput("FUNC")
          .setCheck(null)
          .appendField("Then Run Function");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(45);
   this.setTooltip("Add Event For Block");
   this.setHelpUrl("https://developers.miniworldgame.com/wiki/event.html#block-event-block");
    }
  };
  Blockly.Lua['block_event'] = function(block) {
    var dropdown_block_event = block.getFieldValue('BLOCK_EVENT');
    var statements_func = Blockly.Lua.statementToCode(block, 'FUNC');
    var func = Math.floor(getRandomInt(1,1000000000)+getRandomInt(1,100000000000)+getRandomInt(1,10000000000000));
    var code = 'function func'+func+'(e)\n'+statements_func+'\nend\nScriptSupportEvent:registerEvent([=['+dropdown_block_event+']=],func'+func+')\n';
    return code;
  };
  /////////////////////////////////////////ITEM EVENT
  Blockly.Blocks['item_event'] = {
    init: function() {
      this.appendDummyInput()
          .appendField("When Any Item")
          .appendField(new Blockly.FieldDropdown([["Drop Enters Area","DropItem.AreaIn"], ["Drop Leaves Area","DropItem.AreaOut"], ["Disappear","Item.Disappear"], ["Is Picked Up","Item.Pickup"], ["Projectile Enters Area","Missile.AreaIn"], ["Projectile Leaves Area","Missile.AreaOut"], ["Projectile Is Created","Missile.Create"]]), "ITEM_EVENT");
      this.appendStatementInput("FUNC")
          .setCheck(null)
          .appendField("Then Run Function");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(45);
   this.setTooltip("Add Event For Items");
   this.setHelpUrl("https://developers.miniworldgame.com/wiki/event.html#item-event-item");
    }
  };
  Blockly.Lua['item_event'] = function(block) {
    var dropdown_item_event = block.getFieldValue('ITEM_EVENT');
    var statements_func = Blockly.Lua.statementToCode(block, 'FUNC');
    var func = Math.floor(getRandomInt(1,1000000000)+getRandomInt(1,100000000000)+getRandomInt(1,10000000000000));
    var code = 'function func'+func+'(e)\n'+statements_func+'\nend\nScriptSupportEvent:registerEvent([=['+dropdown_item_event+']=],func'+func+')\n';
    return code;
  };
  ///////////////////////////////////////////PARTICLE EVENT
  Blockly.Blocks['particle_event'] = {
    init: function() {
      this.appendDummyInput()
          .appendField("When Special Effects Have Been Created")
          .appendField(new Blockly.FieldDropdown([["On Any Creatures","Particle.Mob.OnCreate"], ["On Any Players","Particle.Player.OnCreate"], ["On Any Location","Particle.Pos.OnCreate"], ["For Any Projectile","Particle.Projectile.OnCreate"]]), "PARTICLE_EVENT");
      this.appendStatementInput("FUNC")
          .setCheck(null)
          .appendField("Then Run Function");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(45);
   this.setTooltip("Add Event For Particle");
   this.setHelpUrl("https://developers.miniworldgame.com/wiki/event.html#particle-event-particle");
    }
  };
  Blockly.Lua['particle_event'] = function(block) {
    var dropdown_particle_event = block.getFieldValue('PARTICLE_EVENT');
    var statements_func = Blockly.Lua.statementToCode(block, 'FUNC');
    var func = Math.floor(getRandomInt(1,1000000000)+getRandomInt(1,100000000000)+getRandomInt(1,10000000000000));
    var code = 'function func'+func+'(e)\n'+statements_func+'\nend\nScriptSupportEvent:registerEvent([=['+dropdown_particle_event+']=],func'+func+')\n';
    return code;
  };

Blockly.Blocks['text_chat'] = {
    init: function() {
      this.appendValueInput("STRING")
          .setCheck(null)
          .appendField("Send System Chat");
      this.appendValueInput("IDPLAYER")
          .setCheck(null)
          .appendField("For Player ID");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(80);
...
Blockly.Lua['text_chat'] = function(block) {
    var value_string = Blockly.Lua.valueToCode(block, 'STRING', Blockly.Lua.ORDER_ATOMIC);
    var value_idplayer = Blockly.Lua.valueToCode(block, 'IDPLAYER', Blockly.Lua.ORDER_ATOMIC);
    var code = 'Chat:sendSystemMsg('+value_string+','+value_idplayer+')\n';
    return code;
  };
Blockly.Blocks['text_sendchat'] = {
    init: function() {
      this.appendValueInput("STRING")
          .setCheck(null)
          .appendField("Send Chat");
      this.appendValueInput("BYIDPLAYER")
          .setCheck(null)
          .appendField("By Player ID");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(80);
   this.setTooltip("Hello");
...
Blockly.Lua['text_sendchat'] = function(block) {
    var value_string = Blockly.Lua.valueToCode(block, 'STRING', Blockly.Lua.ORDER_ATOMIC);
    var value_idplayer = Blockly.Lua.valueToCode(block, 'BYIDPLAYER', Blockly.Lua.ORDER_ATOMIC);
    var code = 'Chat:sendChat('+value_string+','+value_idplayer+')\n';
    return code;
  };

Blockly.Blocks['Player_EventObjid'] = {
    init: function () {
        this.appendDummyInput()
            .appendField(new Blockly.FieldTextInput('param'),'PARAM')
            .appendField(Blockly.Msg.PLAYER_EVENTOBJID_PARAM_TITLE)
        this.setOutput(true)
        this.setColour(Blockly.Msg.EVERYTHING_HUE);
        
    }
};
Blockly.Lua['Player_EventObjid'] = function (block) {
    var param = block.getFieldValue("PARAM")
    return param+'.eventobjid'
}
